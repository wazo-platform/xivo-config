...
INSERT INTO "ctistatus" VALUES(6,1,'disconnected','Déconnecté','enablednd(false)','#202020','1,2,3,4,5',1);
...
INSERT INTO "extensions" VALUES (nextval('extensions_id_seq'),1,'xivo-features','_*33.',1,'GoSub','agentdynamiclogin,s,1(${EXTEN:3})','agentdynamiclogin');
INSERT INTO "extensions" VALUES (nextval('extensions_id_seq'),1,'xivo-features','_*31.',1,'GoSub','agentstaticlogin,s,1(${EXTEN:3})','agentstaticlogin');
INSERT INTO "extensions" VALUES (nextval('extensions_id_seq'),1,'xivo-features','_*32.',1,'GoSub','agentstaticlogoff,s,1(${EXTEN:3})','agentstaticlogoff');
INSERT INTO "extensions" VALUES (nextval('extensions_id_seq'),1,'xivo-features','_*30.',1,'GoSub','agentstaticlogtoggle,s,1(${EXTEN:3})','agentstaticlogtoggle');
INSERT INTO "extensions" VALUES (nextval('extensions_id_seq'),0,'xivo-features','_*37.',1,'GoSub','bsfilter,s,1(${EXTEN:3})','bsfilter');
INSERT INTO "extensions" VALUES (nextval('extensions_id_seq'),0,'xivo-features','_*664.',1,'GoSub','group,s,1(${EXTEN:4})','callgroup');
INSERT INTO "extensions" VALUES (nextval('extensions_id_seq'),1,'xivo-features','*34',1,'GoSub','calllistening,s,1','calllistening');
INSERT INTO "extensions" VALUES (nextval('extensions_id_seq'),0,'xivo-features','_*667.',1,'GoSub','meetme,s,1(${EXTEN:4})','callmeetme');
INSERT INTO "extensions" VALUES (nextval('extensions_id_seq'),0,'xivo-features','_*665.',1,'GoSub','queue,s,1(${EXTEN:4})','callqueue');
INSERT INTO "extensions" VALUES (nextval('extensions_id_seq'),1,'xivo-features','*26',1,'GoSub','callrecord,s,1','callrecord');
INSERT INTO "extensions" VALUES (nextval('extensions_id_seq'),0,'xivo-features','_*666.',1,'GoSub','user,s,1(${EXTEN:4})','calluser');
INSERT INTO "extensions" VALUES (nextval('extensions_id_seq'),0,'xivo-features','*36',1,'Directory','${CONTEXT}','directoryaccess');
INSERT INTO "extensions" VALUES (nextval('extensions_id_seq'),0,'xivo-features','*25',1,'GoSub','enablednd,s,1','enablednd');
INSERT INTO "extensions" VALUES (nextval('extensions_id_seq'),0,'xivo-features','*90',1,'GoSub','enablevm,s,1','enablevm');
INSERT INTO "extensions" VALUES (nextval('extensions_id_seq'),0,'xivo-features','*91',1,'GoSub','enablevmbox,s,1','enablevmbox');
INSERT INTO "extensions" VALUES (nextval('extensions_id_seq'),0,'xivo-features','_*91.',1,'GoSub','enablevmbox,s,1(${EXTEN:3})','enablevmboxslt');
INSERT INTO "extensions" VALUES (nextval('extensions_id_seq'),0,'xivo-features','_*90.',1,'GoSub','enablevm,s,1(${EXTEN:3})','enablevmslt');
INSERT INTO "extensions" VALUES (nextval('extensions_id_seq'),0,'xivo-features','_*23.',1,'GoSub','feature_forward,s,1(busy,${EXTEN:3})','fwdbusy');
INSERT INTO "extensions" VALUES (nextval('extensions_id_seq'),0,'xivo-features','_*22.',1,'GoSub','feature_forward,s,1(rna,${EXTEN:3})','fwdrna');
INSERT INTO "extensions" VALUES (nextval('extensions_id_seq'),0,'xivo-features','_*21.',1,'GoSub','feature_forward,s,1(unc,${EXTEN:3})','fwdunc');
INSERT INTO "extensions" VALUES (nextval('extensions_id_seq'),0,'xivo-features','*20',1,'GoSub','fwdundoall,s,1','fwdundoall');
...
INSERT INTO "extensions" VALUES (nextval('extensions_id_seq'),0,'xivo-features','_*56.',1,'GoSub','groupmember,s,1(queue,add,${EXTEN:3})','queueaddmember');
INSERT INTO "extensions" VALUES (nextval('extensions_id_seq'),0,'xivo-features','_*57.',1,'GoSub','groupmember,s,1(queue,remove,${EXTEN:3})','queueremovemember');
INSERT INTO "extensions" VALUES (nextval('extensions_id_seq'),0,'xivo-features','_*55.',1,'GoSub','groupmember,s,1(queue,toggle,${EXTEN:3})','queuetogglemember');
INSERT INTO "extensions" VALUES (nextval('extensions_id_seq'),0,'xivo-features','*9',1,'GoSub','recsnd,s,1(wav)','recsnd');
INSERT INTO "extensions" VALUES (nextval('extensions_id_seq'),0,'xivo-features','_*99.',1,'GoSub','vmboxmsg,s,1(${EXTEN:3})','vmboxmsgslt');
INSERT INTO "extensions" VALUES (nextval('extensions_id_seq'),1,'xivo-features','_*93.',1,'GoSub','vmboxpurge,s,1(${EXTEN:3})','vmboxpurgeslt');
INSERT INTO "extensions" VALUES (nextval('extensions_id_seq'),0,'xivo-features','_*97.',1,'GoSub','vmbox,s,1(${EXTEN:3})','vmboxslt');
INSERT INTO "extensions" VALUES (nextval('extensions_id_seq'),0,'xivo-features','*98',1,'GoSub','vmusermsg,s,1','vmusermsg');
INSERT INTO "extensions" VALUES (nextval('extensions_id_seq'),1,'xivo-features','*92',1,'GoSub','vmuserpurge,s,1','vmuserpurge');
INSERT INTO "extensions" VALUES (nextval('extensions_id_seq'),1,'xivo-features','_*92.',1,'GoSub','vmuserpurge,s,1(${EXTEN:3})','vmuserpurgeslt');
INSERT INTO "extensions" VALUES (nextval('extensions_id_seq'),0,'xivo-features','_*96.',1,'GoSub','vmuser,s,1(${EXTEN:3})','vmuserslt');
INSERT INTO "extensions" VALUES (nextval('extensions_id_seq'),0,'xivo-features','_*11.',1,'GoSub','paging,s,1(${EXTEN:3})','paging');
INSERT INTO "extensions" VALUES (nextval('extensions_id_seq'),0,'xivo-features','*14',1,'GoSub','alarmclk-set,s,1','alarmclk-set');
INSERT INTO "extensions" VALUES (nextval('extensions_id_seq'),0,'xivo-features','*15',1,'GoSub','alarmclk-clear,s,1','alarmclk-clear');
...
INSERT INTO "extenumbers" VALUES (nextval('extenumbers_id_seq'),'*14','7b32828c56cbc865729669a824d098c1e6584ae9','','extenfeatures','alarmclk-set');
INSERT INTO "extenumbers" VALUES (nextval('extenumbers_id_seq'),'*15','509d0dd56f5acd077613872f49e1dab759b1a435','','extenfeatures','alarmclk-clear');
